...
public class HomeFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // mengambil dan menampilkan data dari db
        initalizeHome();
    ...
    // set main view
    // ngubah view method dalam fragment
    ...
    private void updateTableItems(String stringDate, String stringMealNumber){
        ...
        for(int x=0;x<intCursorFdCount;x++){
            ...
            if(stringMealNumber.equals("0")) {
                tl = (TableLayout) getActivity().findViewById(R.id.tableLayoutBreakfastItems);
            }
            else if(stringMealNumber.equals("1")) {
                tl = (TableLayout) getActivity().findViewById(R.id.tableLayoutLunchItems);
            }
            else if(stringMealNumber.equals("2")) {
                tl = (TableLayout) getActivity().findViewById(R.id.tableLayoutBeforeTrainingItems);
            }
            else if(stringMealNumber.equals("3")) {
                tl = (TableLayout) getActivity().findViewById(R.id.tableLayoutAfterTrainingItems);
            }
            else if(stringMealNumber.equals("4")) {
                tl = (TableLayout) getActivity().findViewById(R.id.tableLayoutDinnerItems);
            }
            else if(stringMealNumber.equals("5")) {
                tl = (TableLayout) getActivity().findViewById(R.id.tableLayoutSnacksItems);
            }
            ...
            paramsEnergy.setMargins(0, 8, 10, 0);
    ...
    public void calcualteNumberOfCalEatenToday(String stringDate){
        ...
        int intLebihTarget50 = intGoalEnergyWithActivityAndDiet - (intGoalEnergyWithActivityAndDiet + 50);
        int intLebihTarget100 = intGoalEnergyWithActivityAndDiet - (intGoalEnergyWithActivityAndDiet + 100);
        int intLebihTarget150 = intGoalEnergyWithActivityAndDiet - (intGoalEnergyWithActivityAndDiet + 150);
        int intLebihTarget200 = intGoalEnergyWithActivityAndDiet - (intGoalEnergyWithActivityAndDiet + 200);
        int intLebihTarget250 = intGoalEnergyWithActivityAndDiet - (intGoalEnergyWithActivityAndDiet + 250);
        int intLebihTarget300 = intGoalEnergyWithActivityAndDiet - (intGoalEnergyWithActivityAndDiet + 300);
        int intLebihTarget350 = intGoalEnergyWithActivityAndDiet - (intGoalEnergyWithActivityAndDiet + 350);
        int intLebihTarget400 = intGoalEnergyWithActivityAndDiet - (intGoalEnergyWithActivityAndDiet + 400);

        if ((textViewBodyResult > intLebihTarget50)&&(textViewBodyResult < 0)){
            TextView textViewBodySaran = (TextView) getActivity().findViewById(R.id.textViewBodySaran);
            textViewBodySaran.setText("Kamu sudah melebihi target kalori, disarankan untuk berolahraga: Bersepeda selama 7 menit / lari selama 5 menit / berenang selama 6 menit");
        }else if ((textViewBodyResult > intLebihTarget100)&&(textViewBodyResult < intLebihTarget50)){
            TextView textViewBodySaran = (TextView) getActivity().findViewById(R.id.textViewBodySaran);
            textViewBodySaran.setText("Kamu sudah melebihi target kalori, disarankan untuk berolahraga: Bersepeda selama 14 menit / lari selama 10 menit / berenang selama 12 menit");
        }else if ((textViewBodyResult > intLebihTarget150)&&(textViewBodyResult < intLebihTarget100)){
            TextView textViewBodySaran = (TextView) getActivity().findViewById(R.id.textViewBodySaran);
            textViewBodySaran.setText("Kamu sudah melebihi target kalori, disarankan untuk berolahraga: Bersepeda selama 21 menit / lari selama 15 menit / berenang selama 18 menit");
        }else if ((textViewBodyResult > intLebihTarget200)&&(textViewBodyResult < intLebihTarget150)){
            TextView textViewBodySaran = (TextView) getActivity().findViewById(R.id.textViewBodySaran);
            textViewBodySaran.setText("Kamu sudah melebihi target kalori, disarankan untuk berolahraga: Bersepeda selama 28 menit / lari selama 20 menit / berenang selama 24 menit");
        }else if ((textViewBodyResult > intLebihTarget250)&&(textViewBodyResult < intLebihTarget200)){
            TextView textViewBodySaran = (TextView) getActivity().findViewById(R.id.textViewBodySaran);
            textViewBodySaran.setText("Kamu sudah melebihi target kalori, disarankan untuk berolahraga: Bersepeda selama 35 menit / lari selama 25 menit / berenang selama 30 menit");
        }else if ((textViewBodyResult > intLebihTarget300)&&(textViewBodyResult < intLebihTarget250)){
            TextView textViewBodySaran = (TextView) getActivity().findViewById(R.id.textViewBodySaran);
            textViewBodySaran.setText("Kamu sudah melebihi target kalori, disarankan untuk berolahraga: Bersepeda selama 42 menit / lari selama 30 menit / berenang selama 36 menit");
        }else if ((textViewBodyResult > intLebihTarget350)&&(textViewBodyResult < intLebihTarget300)){
            TextView textViewBodySaran = (TextView) getActivity().findViewById(R.id.textViewBodySaran);
            textViewBodySaran.setText("Kamu sudah melebihi target kalori, disarankan untuk berolahraga: Bersepeda selama 49 menit / lari selama 35 menit / berenang selama 42 menit");
        }else if ((textViewBodyResult > intLebihTarget400)&&(textViewBodyResult < intLebihTarget350)){
            TextView textViewBodySaran = (TextView) getActivity().findViewById(R.id.textViewBodySaran);
            textViewBodySaran.setText("Kamu sudah melebihi target kalori, disarankan untuk berolahraga: Bersepeda selama 56 menit / lari selama 40 menit / berenang selama 48 menit");
        }else if (textViewBodyResult < intLebihTarget400){
            TextView textViewBodySaran = (TextView) getActivity().findViewById(R.id.textViewBodySaran);
            textViewBodySaran.setText("Kamu sudah melebihi target kalori, disarankan untuk berolahraga: Bersepeda selama > 56 menit / lari selama > 40 menit / berenang selama > 48 menit");
        }
    }
